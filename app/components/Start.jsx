...
const Instruction3 = ({ onPreviousClick, onStartClick, containerBorder, HrColor }) => {
  return (
    ...
    <div id="start-container" className="p-6 bg-black bg-opacity-60 rounded mx-auto text-center text-white md:max-w-2xl">
      ...
      <div className="grid grid-cols-2 gap-4 justify-center">
        ...
        <button id="start-next" className="bg-green-500 text-white text-center px-3 py-2 rounded" onClick={onStartClick}>Start</button>
      </div>
    </div>
    </div>
  );
