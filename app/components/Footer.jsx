...
const Footer = () => {
  return (
    <div className="relative flex flex-col w-full bg-black/80 text-white text-center text-opacity-60 justify-center items-center mt-40 pt-5 pb-5 pr-1 pl-1">
      ...
      <a href="https://www.instagram.com/timewisequiz/" title="Instagram"><img className='h-9 w-9 hover:w-10 hover:h-10 m-4 mt-5 opacity-60' src="images/instagram-icon.png" alt="Instagram" /></a>
      <a href="mailto:info@timewisequiz.com" className="hover:text-pink-500 text-xl hover:text-2xl block mt-2" title='email'>info@timewisequiz.com</a>
