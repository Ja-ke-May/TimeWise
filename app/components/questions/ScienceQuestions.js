export const scienceQuestions = [
  ...
  {
    question: "In the periodic table, which element has the symbol 'Fe'?",
  ...
  },
  {
    ...
    {
      question: "In chemistry, what is the pH scale used to measure?",
      options: ["Density", "Temperature", "Acidity", "Pressure"],
